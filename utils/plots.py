...
class Annotator:
    ...
    def box_label(self, box, polygon, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                _len = len(polygon)
                xl = int(sum(_x_list) / _len)
                yl = int(sum(_y_list) / _len)
    ...
    def find_centerpolygon(self, polygon, label, color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if yl > 360 and yl < 380 :
            cv2.line(self.im,(0,370),(1280,370),(0,255,0),4)
            h = int(self.im.shape[0])
            w = int(self.im.shape[1])
            # ser.write(f'{w-xl} {yl}\n'.encode())
            ser.write(f'{w-xl}\n'.encode())
            # return xl,yl,h,w
        else:
